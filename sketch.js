...
function setup() {
	...
	c1=new Rope(roof.body,bob1.body);
	c2=new Rope(roof.body,bob2.body);
	c3=new Rope(roof.body,bob3.body);
	c4=new Rope(roof.body,bob4.body);
    c5=new Rope(roof.body,bob5.body);
